...
import com.example.healthcare.Background.BackGrountTask;
import com.example.healthcare.Database.SqliteDatabaseHandler;
...
public class MainActivity extends AppCompatActivity {
    ...
    BackGrountTask backGrountTask = new BackGrountTask();
    @Override
